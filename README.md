...
The frontend of the application is built with ReactJS, Material UI, React-router-dom,ContextAPI. The source code for the frontend can be found at [https://github.com/akechi0523/e-commerce-frontend](https://github.com/akechi0523/e-commerce-frontend).
